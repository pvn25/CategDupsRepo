...
skewPresent = 1 # if skew is not present in duplication parameters, then only specify the below parameters.
...
echo "$numD $dr $dxr $tre $dupColIndex $skewPresent $PercEnty $PercOccur $GrpSize"
